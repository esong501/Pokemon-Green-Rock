...
static void CreateStopSurfingTask(u8 direction)
{
    ...
    // honestly not sure what changing this does
...
static void Task_WaitStopSurfing(u8 taskId)
{
    ...
    if (ObjectEventClearHeldMovementIfFinished(playerObjEvent))
    {
        ...
        // the following line makes the game render grounded effects after getting off a surfing Pokemon
        // i.e. if you stop surfing onto a grass tile, character will appear in the grass and not on top
