...
// Berries
    ...
    [ITEM_SITRUS_BERRY] =
    {
        ...
        .price = 20,
        // we need to edit the next two parameters
        // .holdEffect = HOLD_EFFECT_RESTORE_HP,
        // this changes the HP to a percent
    ...
    [ITEM_FIGY_BERRY] =
    {
        ...
        // we need to change this parameter to make these berries heal 1/3 HP instead of an 1/8
        .holdEffectParam = 3,
...
// TMs/HMs
// in order to make TMs function like HMs (can't be held, tossed, etc.)
// we need to change its importance parameter
