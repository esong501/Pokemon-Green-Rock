...
s32 MoveBattleBar(u8 battlerId, u8 healthboxSpriteId, u8 whichBar, u8 unused)
{
    ...
    {
        // there's really nothing wrong with this block of code
        // but, we can make the HP bar drain faster for Pokemon with more health
        // originally, the last paramter of this function call was 1
        // but we'll change it to take the max value between 1 and the opposing Pokemon's health / 32
