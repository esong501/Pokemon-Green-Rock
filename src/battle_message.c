...
// these next two lines end up being redundant in English despite having use in Japanese
...
static const u8 sText_PkmnComeBack[] = _("{B_BUFF1}, return!");
static const u8 sText_PkmnOkComeBack[] = _("{B_BUFF1}, OK!\nCome back!");
static const u8 sText_PkmnGoodComeBack[] = _("{B_BUFF1}, good job!\nCome back!");
...
// adding an exclamation mark to the end here to fix the redundant grammar changes
...
const u16 gWeatherStartsStringIds[] =
{
    ...
    // let's make it so that snow actually trigger the right weather string and not for rain
...
// this is totally unnecessary, so we'll just comment it out
...
// totally unnecessary, we'll comment this out too
